...
> In Anwendungen: Momentan- vs. Gesamtänderung, Bestand aus Rate rekonstruieren, Mittelwert einer Funktion über einem Intervall. Einheiten und Antwortsatz nicht vergessen.
...
1. $$\int_a^b f'(t)\,dt = f(b) - f(a) = \text{Gesamtänderung im Intervall } [a;\,b]$$
...
- $$\bar{f} = \frac{1}{b - a} \cdot \int_a^b f(x)\,dx$$
