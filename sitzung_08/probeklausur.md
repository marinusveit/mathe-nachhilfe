...
**Teil B:** mit Hilfsmitteln (50 Min, 30 BE)
...
a) $f(x) = 3x^4 - 2x^2 + 5x - 1$ **(1 BE)**

b) $g(x) = (2x + 1)^5$ **(1 BE)**

c) $h(x) = x^2 \cdot e^x$ **(2 BE)**
...
a) Bestimme die Nullstellen von $f$. **(2 BE)**

b) Zeige, dass $f$ an der Stelle $x = 1$ ein lokales Minimum hat. **(3 BE)**
...
a) Wenn $f'(x_0) = 0$ gilt, dann hat $f$ an der Stelle $x_0$ ein Extremum. **(1 BE)**
...
## Punkteverteilung Zusammenfassung
