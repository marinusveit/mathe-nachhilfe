...
Bestimme die Gleichung der Tangente an den Graphen von f(x) = x³ − 2x + 1 im Punkt P(1 | f(1)).

---

## Aufgabe 7: Extrema bestimmen (4 Punkte)

Gegeben ist f(x) = x³ − 6x² + 9x − 2.
...
b) Skizziere den Graphen von g(x) = x² − 2x im Intervall [0; 2].
...
Gegeben ist f(x) = x⁴ − 2x².

a) Zeige, dass f achsensymmetrisch zur y-Achse ist.

b) Bestimme das Verhalten von f(x) für x → ±∞.
